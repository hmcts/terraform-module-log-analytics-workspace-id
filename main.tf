...
locals {
  log_analytics_env_mapping = {
    ...
    nonprod = ["dev", "idam-preview", "idam-vault-preview", "preview", "test", "idam-ithc", "idam-vault-ithc" "ithc", "idam-demo", "idam-vault-demo", "demo", "stg", "idam-aat", "idam-vault-aat", "idam-aat2", "aat", "idam-perftest", "idam-vault-perftest","perftest", "nonprodi"]
    prod    = ["idam-prod", "idam-prod2", "idam-vault-prod", "prod", "mgmt", "ldata", "prod-int", "ptl"]
  }
